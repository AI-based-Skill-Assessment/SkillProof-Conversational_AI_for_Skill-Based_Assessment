...
USAGE:
  python scripts/cli/voice_cli.py --session <SESSION_UUID>
  python scripts/cli/voice_cli.py --session <SESSION_UUID> --url ws://127.0.0.1:8000

Press ENTER after each answer to confirm you're done speaking.
Or let it auto-detect silence after 2.5 seconds.
"""
